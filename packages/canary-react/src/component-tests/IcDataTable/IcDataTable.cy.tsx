...
describe("IcDataTables", () => {
  ...
  it("should render embedded", () => {
    ...
    cy.compareSnapshot({
      name: "embedded",
      testThreshold: setThresholdBasedOnEnv(DEFAULT_THRESHOLD + 0.29),
      cypressScreenshotOptions: {
        capture: "viewport",
      },
    });
  ...
  it("should correctly render a custom icon in the header when passed through the column prop", () => {
    ...
    cy.compareSnapshot({
      name: "custom-icons",
      testThreshold: setThresholdBasedOnEnv(DEFAULT_THRESHOLD + 0.026),
      cypressScreenshotOptions: {
        capture: "viewport",
      },
    });
  ...
  it('should not render custom icon in header when "hideOnHeader" is set', () => {
    ...
    cy.compareSnapshot({
      ...
      testThreshold: setThresholdBasedOnEnv(DEFAULT_THRESHOLD + 0.26),
      cypressScreenshotOptions: {
        capture: "viewport",
      },
    });
  ...
  it("should apply the correct density scaler to rowHeights", () => {
    ...
    cy.compareSnapshot({
      name: "density-dense",
      testThreshold: setThresholdBasedOnEnv(DEFAULT_THRESHOLD + 0.39),
    });
